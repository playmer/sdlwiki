...
Please read [AppFreezeDuringDrag](AppFreezeDuringDrag) for a technical explanation and solutions.
...
- OpenGL and it's versions and variants
  ...
  - The main downside is that by getting this wide platform support you're trading away both modern API design, and also modern APIs in general. Even targeting very new computers, it's likely you'd want to use the latest features in 4.6, which is unavailable on MacOS.
- Vulkan
